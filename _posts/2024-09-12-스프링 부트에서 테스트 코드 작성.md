...
또한, 이전에는 @SpringBootTest라는 어노테이션을 많이 썼었는데, 이 둘의 차이는 다음과 같다.  
- `@WebMvcTest(HelloController.class)` : Spring의 테스트 기능을 활성화하고 관련된 기능을 사용할 수 있게 한다.  
...
**HelloController에 ResponeDto를 사용하는 코드를 추가해보자**  
